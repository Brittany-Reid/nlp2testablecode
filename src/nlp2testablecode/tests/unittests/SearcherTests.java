...
import nlp2testablecode.Searcher;
import nlp2testablecode.code.Snippet;

/**
 * Test the @nlp2testablecode.Searcher class.
 */
public class SearcherTests {
	...
	/**
	 * Check that an empty query works correctly.
	 */
	@Test
	public void noResults() throws Exception{
		...
		List<Snippet> snippets = Searcher.getSnippets("aaaaaaaaaaa");
		assertNotNull(snippets);
