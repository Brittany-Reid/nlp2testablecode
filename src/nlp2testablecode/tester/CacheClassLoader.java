...
import nlp2testablecode.compiler.*;
...
public class CacheClassLoader extends URLClassLoader {
	private static final String BRIDGE_CLASS_NAME = nlp2testablecode.tester.testprocess.JUnitBridge.class.getName();
	...
	private static final URL[] classPathToURLs(String classPath) {
		...
		URL u;
		u = (FileLocator.find(Platform.getBundle("nlp2testablecode"), new Path("bin/"), null));
		try {
