...
/**
 * Handles loading of data sources, including stack overflow answers, questions, stop words and task suggestions.
 */
public class DataHandler {
	...
	public static URL getURL(String url) {
		...
		try {
			...
			result = new URL("platform:/plugin/nlp2testablecode/" + url);
